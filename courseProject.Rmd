...
Random forests provided highest accuracy on test set. Therefore, random forests were chosen as a final model. Out-of-sample error can be estimated using the validation set.

```{r}
finalEstimation <- confusionMatrix(predict(randomForestModel, xVal), xVal$classe)
...
Validation set accuracy: `r round(finalAccuracy*100, digits=4)`% with 95% confidence intervals being [`r round(finalAccuracyLower95*100, digits=4)`,`r round(finalAccuracyHigher95*100, digits=4)`] %. Therefore, out-of-smaple error can be estimated as `r round(outOfSampleErroEstimation*100, digits=4)`% with 95% confidence intervals being [`r round(outOfSampleLower95*100, digits=4)`,`r round(outOfSampleHigher95*100, digits=4)`] %
...
- We expect out-of-sample error to be `r round(outOfSampleErroEstimation*100, digits=4)`% with 95% confidence intervals being [`r round(outOfSampleLower95*100, digits=4)`,`r round(outOfSampleHigher95*100, digits=4)`] %. Out-of-sample error was estimated using validation set accuracy.
- Cross-validation was used to estimated confidence interval for out-of-sample error.
